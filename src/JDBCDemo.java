...
public class JDBCDemo {
	...
	public static void insertRecord() throws Exception{
		...
		String query = "insert into employee values (209,'NAVEEN',250000)";
	...
	public static void commitdemo() throws Exception{
		...
		String query1 = "update employee set salary = 550000 where emp_id=206";
		String query2 = "update employee set salary = 550000 where emp_id=207";
